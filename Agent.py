...
class Agent():
    ...
    def update_dist_params(self, obs):
        ...
        observed_dist = np.array([self.percent_correct(observations,0),
                                  self.percent_correct(observations,1),
                                  self.percent_correct(observations,2)])
        n = observations.size
    ...
    def percent_correct(self, array, element):
        """ 
